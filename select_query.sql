...
-- select query
-- when you wangt to show complete table data 
-- select*from table_name
select*from employees;

-- when you want to show specific column 
-- select column1, column2,column3 from table_name;
select first_name,last_name,salary from employees;
-- when yopu wanrt to show data according to condition 
...
select * from employees where job_id in ('it_prog','ad_vp','sh_clerk');

-- not in 
select * from employees where job_id not in ('it_prog','ad_vp','sh_clerk');

-- and
select * from employees where salary >5000 and job_id='it_prog';

-- creat a bonus column as 10% of the salary
select first_name,last_name,salary*10/100 as 'Bonus' from employees;
select 12*20+10-50/5;
-- max
...
-- avg
select avg(salary) as 'Avetrage salary' from employees;

-- Write a query to get the name (first_name,last_name),salary,PF of all the employees (PF is calculated as 15% of salary)
...
select max(salary) as 'maximun', min(salary) as 'mimimun' from employees ;

-- Write a query to get the employee id,name(fierst_name,last_name),salary in ascending order of salary;

select first_name,last_name,salary,employee_id from employees order by salary;
-- Write a query to get the number of designation available in the employees table;
